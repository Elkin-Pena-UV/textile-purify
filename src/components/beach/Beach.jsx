  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene" rotation={[-Math.PI / -0.2, -0.4, 9.43]}>
        ...
        <group
          name="Cube099"
          position={[0.108, 0.526, -1.985]}
          scale={[0.008, 0.008, 0.199]}
        />
        <group
          name="Cube100"
          position={[0.108, 0.212, -1.83]}
          scale={[0.008, 0.008, 0.199]}
        />
        <group
          name="Cube101"
          position={[0.108, 0.245, -1.464]}
          scale={[0.008, 0.008, 0.199]}
        />
        <group
          name="Cube102"
          position={[0.108, 0.171, -1.766]}
          scale={[0.008, 0.008, 0.199]}
        />
        <group
          name="Cube103"
          position={[0.108, 0.9, -1.831]}
          scale={[0.008, 0.008, 0.199]}
        />
        <group
          name="Cube104"
          position={[0.108, 0.963, -1.419]}
          scale={[0.008, 0.008, 0.199]}
        />
        <mesh
          name="Cube746"
        ...
        <group
          name="Cube073"
          position={[-0.021, 0.085, -0.257]}
          scale={[0.006, 0.006, 0.033]}
        />
        <mesh
          name="Plane016"
          castShadow
